...
namespace OCA\Files_External_MOE\Config;

use OCP\Files\Storage;
use OC\Files\Mount\MountPoint;
use OCP\Files\Storage\IStorageFactory;
use OCA\Files_External_MOE\Lib\PersonalMount;
use OCP\Files\Config\IMountProvider;
use OCP\IUser;
use OCA\Files_External_MOE\Service\UserStoragesService;
use OCA\Files_External_MOE\Service\UserGlobalStoragesService;
use OCA\Files_External_MOE\Lib\StorageConfig;
use OCP\Files\StorageNotAvailableException;
use OCA\Files_External_MOE\Lib\FailedStorage;

/**
 * Make the old files_external_moe config work with the new public mount config api
 */
