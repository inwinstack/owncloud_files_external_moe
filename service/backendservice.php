...
namespace OCA\Files_External_MOE\Service;
...
class BackendService {
	...
	public function __construct(
		...
		// Load config values
		if ($this->config->getAppValue('files_external_moe', 'allow_user_mounting', 'yes') !== 'yes') {
			$this->userMountingAllowed = false;
		}
		$this->userMountingBackends = explode(',',
			$this->config->getAppValue('files_external_moe', 'user_mounting_backends', '')
		);
