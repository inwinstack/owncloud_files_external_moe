...
$this->create('files_external_moe_oauth1', 'ajax/oauth1.php')
	->actionInclude('files_external_moe/ajax/oauth1.php');
$this->create('files_external_moe_oauth2', 'ajax/oauth2.php')
	->actionInclude('files_external_moe/ajax/oauth2.php');

$this->create('files_external_moe_externalpathcheck', 'ajax/externalpathcheck.php')
	->actionInclude('files_external_moe/ajax/externalpathcheck.php');
