...
class DropboxFile
{
    ...
    public function open()
    {
        ...
        $this->stream = \DGuzzleHttp\Psr7\stream_for(fopen($this->path, 'r'));
    ...
    {
        return \DGuzzleHttp\Psr7\mimetype_from_filename($this->path) ?: 'text/plain';
    }
