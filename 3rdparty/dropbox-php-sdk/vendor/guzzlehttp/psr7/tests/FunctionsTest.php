...
class FunctionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $s = $this->getMockBuilder('DGuzzleHttp\Psr7\Stream')
            ->setMethods(['read', 'eof'])
    ...
    {
        $this->assertInstanceOf('DGuzzleHttp\Psr7\Uri', Psr7\uri_for('/foo'));
        $this->assertInstanceOf(
            'DGuzzleHttp\Psr7\Uri',
    ...
    public function testCreatesWithFactory()
    {
        ...
        $this->assertInstanceOf('DGuzzleHttp\Psr7\Stream', $stream);
    ...
    {
        $s = Psr7\stream_for();
        $this->assertInstanceOf('DGuzzleHttp\Psr7\Stream', $s);
    }
    ...
    public function testCanCreateIteratorBasedStream()
    {
        ...
        $p = Psr7\stream_for($a);
        $this->assertInstanceOf('DGuzzleHttp\Psr7\PumpStream', $p);
