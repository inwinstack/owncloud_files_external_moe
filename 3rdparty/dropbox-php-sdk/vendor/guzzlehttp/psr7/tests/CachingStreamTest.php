...
use DGuzzleHttp\Psr7\CachingStream;

/**
 * @covers DGuzzleHttp\Psr7\CachingStream
 */
class CachingStreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRewindUsesSeek()
    {
        ...
        $d = $this->getMockBuilder('DGuzzleHttp\Psr7\CachingStream')
    ...
    public function testCanSeekToReadBytesWithPartialBodyReturned()
    {
        ...
        $this->decorated = $this->getMockBuilder('\DGuzzleHttp\Psr7\Stream')
