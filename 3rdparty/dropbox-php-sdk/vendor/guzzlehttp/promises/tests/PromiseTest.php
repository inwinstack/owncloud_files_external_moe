...
use DGuzzleHttp\Promise\CancellationException;
use DGuzzleHttp\Promise as P;
use DGuzzleHttp\Promise\Promise;
use DGuzzleHttp\Promise\RejectedPromise;
use DGuzzleHttp\Promise\RejectionException;

/**
 * @covers DGuzzleHttp\Promise\Promise
 */
class PromiseTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \DGuzzleHttp\Promise\CancellationException
     */
    ...
    public function testCreatesPromiseWhenFulfilledWithNoCallback()
    {
        ...
        $p2 = $p->then();
        $this->assertNotSame($p, $p2);
        $this->assertInstanceOf('DGuzzleHttp\Promise\FulfilledPromise', $p2);
    }
    ...
    public function testCreatesPromiseWhenRejectedWithNoCallback()
    {
        ...
        $p2 = $p->then();
        $this->assertNotSame($p, $p2);
        $this->assertInstanceOf('DGuzzleHttp\Promise\RejectedPromise', $p2);
    }
