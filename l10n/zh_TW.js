OC.L10N.register(
    ...
    "Add" : "新增",
    "Cancel" : "取消",
    "System will create a folder in your file list." : "系統會在您的檔案列表建立資料夾。",
    "This folder allows you to access files that are mounted on an external cloud personal space." : "您可以透過此資料夾存取掛載之外部雲端個人空間的檔案。",
    "Please input a name for this folder:" : "請為此資料夾命名：",  
    "The folder name already existed" : "資料夾名稱已存在",
    "The folder name contains invalid characters" : "資料夾名稱包含無效字元",
    "Delete" : "刪除",
